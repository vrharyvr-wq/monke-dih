...
class GameInfo:
    def __init__(self):
        self.TitleId: str = "FD144"  # Playfab Title Id
        self.SecretKey: str = "ZQCUOIWFTGX93B5Z7ZCSP3DC9MRXQQ4WDXIHIGBNB3M1NMZSIB"  # Playfab Secret Key
        self.ApiKey: str = "OC|1196373983559785|eb03c824c6ad52043d0a3a692ef0aee4"  # App Api Key (Oculus/Graph API)
...
def titledata():
    response_data = {
        ...
        "MOTD": "<color=#FFC0CB>WELCOME TO MONKEY PARADISE!</color>\n\n<color=#0099c2>CURRENT UPDATE: CITY REVAMP 24</color>\n<color=#cacfd2>WERE GLAD YOUR HERE MAKE SURE TO JOIN THE DISCORD JESUS/GOD LOVES YOU FOLLOW GOD AND JESUS</color>\n<color=#41ff80>ZENON MADE THIS MOTD</color>\n<color=#6417ff>OUR DEVELOPERS ARE: ZENON</color>\n<color=#ac1a00>OWNERS ARE: ACE/CAVEVR</color>\n\n<color=#91A3B0>https://discord.gg/KuQVzEvFkb</color>",
